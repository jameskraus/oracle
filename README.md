...
| `-m, --model <name>`                                                           | Built-ins (`gpt-5.6-sol-pro` default, `gpt-5.5-pro`, `gpt-5.4-pro`, `gpt-5.4`, `gpt-5.1-pro`, `gpt-5.1`, `gpt-5.1-codex`, `gpt-5.2`, `gpt-5.2-instant`, `gpt-5.2-pro`, `gemini-3.1-pro` API + UI, `gemini-3-pro`, `claude-4.6-sonnet`, `claude-4.1-opus`, ...) plus any OpenRouter id (e.g., `minimax/minimax-m2`, `openai/gpt-4o-mini`). |
